...
export const ourSpecsData = [
    { title: "Live BTC rate", description: "Enjoy fast, free price conversion on every minute no conditions, just reliable trust.", icon: SendIcon, accent: '#05DF72' },
    { title: "Multi Vendor Dapp", description: "Checkout powered by cryptocurrency to make transactions quick and trustworthy.", icon: ClockFadingIcon, accent: '#FF8904' },
