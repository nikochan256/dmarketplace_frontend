            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        Welcome to DmarketPlace — the future of shopping powered by Web3. We’re a decentralized multi-vendor dApp where the latest and smartest gadgets meet blockchain transparency, giving users and vendors a secure, open, and truly connected marketplace — all in one place.                            </p>
